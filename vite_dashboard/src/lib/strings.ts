...
export const STRINGS = {
  ...
  contacts: {
    ...
    drawer: {
      ...
      flowsTab: {
        ...
        addButton: "Add",
        addPlaceholder: "— Select a flow —",
        noActiveFlows: "No active flows for this contact.",
        noPastFlows: "No past flows.",
        ...
        markShippedCancel: "Cancel",
        markShippedTitle: "Mark sample shipped",
        markShippedHelp:
          "Adds the samples_shipped tag and resumes step 1 of Sample Dispatch with this tracking info.",
        pause: "Pause",
        resume: "Resume",
        stop: "Stop",
        nextFireWaiting: "Waiting for {event} event",
        nextFireAt: "Next fire: {when}",
        startedAt: "Started: {when}",
        endedAt: "Ended: {when}",
        stepProgress: "Step {n} of {total}",
        completedSummary: "{sent} of {total} steps sent",
        errorAlreadyEnrolled: "Already enrolled in this flow.",
        errorFlowInactive: "This flow is inactive.",
        errorAlreadyShipped: "Already marked shipped.",
        errorContactNotFound: "Contact not found.",
        errorBadTransition:
          "Membership is not in a state that allows this action.",
  ...
  flows: {
    detail: {
      ...
      resumeAction: "Resume",
      stopAction: "Stop",
      confirmStopTitle: "Stop this flow for {name}?",
      confirmStopBody:
        "The membership will be terminal — no further steps fire. Restart by re-applying the trigger tag.",
      confirmPauseTitle: "Pause this flow for {name}?",
      confirmPauseBody:
        "The membership will hold until you click Resume. The next fire is paused.",
      flowNotFound: "Flow not found.",
      partialFailureBadge: "Partial step failure",
    },
  },
} as const;
