/**
 * Dialog primitive — Radix Dialog wrapped with Shadcn styling.
 * Used by AddContactDialog + ImportContactsDialog.
 */
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 grid w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 border border-border bg-bg p-6 shadow-xl rounded-lg",
